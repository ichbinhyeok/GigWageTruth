...
public enum WorkLevel {
     ...
     */
    public String getWorkLevelMeaning(String appName, String cityName) {
        switch (this) {
            case PART_TIME:
                return String.format(
                        "<p class=\"text-slate-700 leading-relaxed mb-4\">" +
                                ...
                                "</p>" +
                                "<p class=\"text-slate-700 leading-relaxed mb-4\">" +
                                "The real strategy at this level is <strong>time optimization</strong>. You can't afford to waste Saturday mornings sitting in an airport queue. "
                                +
                                "In %s, focus on the highest-demand windows: Friday/Saturday nights (8 PM - 2 AM) for rideshare, or lunch rushes (11 AM - 1 PM) for delivery. "
                                +
     ...
     */
    public String getTaxStrategy(String appName, String cityName) {
        switch (this) {
            case PART_TIME:
     ...
     */
    public String getDayInTheLife(String appName, String cityName, CityData city) {
        switch (this) {
            case PART_TIME:
                return String.format(
                        "<h3 class=\"text-xl font-bold text-slate-900 mb-3\">📅 A Typical Part-Time Shift in %s</h3>" +
                                ...
                                +
                                "<li><strong>8:00 PM:</strong> Go online near [popular nightlife district]. First ping comes in 3 minutes.</li>"
                                +
            ...
            case FULL_TIME:
                return String.format(
                        "<h3 class=\"text-xl font-bold text-slate-900 mb-3\">📅 A Typical Full-Time Day in %s</h3>" +
                                ...
                                "<ul class=\"space-y-3 text-slate-700\">" +
                                "<li><strong>7:00 AM - 9:00 AM:</strong> Morning commute surge. Position near business districts or airports. "
                                +
                                ...
                                +
                                "<li><strong>11:00 AM - 1:30 PM:</strong> Lunch rush. %s office workers ordering food. Park near restaurant clusters. 6-7 deliveries, $60-80 gross.</li>"
                                +
     ...
     */
    public String getBestPractices(String appName, String cityName, CityData city) {
        StringBuilder practices = new StringBuilder();
        practices.append(
                "<h3 class=\"text-xl font-bold text-slate-900 mb-3\">🎯 Pro Tips for " + displayName + " Drivers</h3>");
        ...
        switch (this) {
            case PART_TIME:
                ...
                practices.append("<li><strong>Know Your 'Strike Zone':</strong> Identify the 2-3 neighborhoods in ")
                        .append(cityName)
                        .append(" where you consistently get high-value pings, and stick to them.</li>");
                practices.append(
                        "<li><strong>Avoid the Airport Queue:</strong> Unless you live 5 minutes from the airport, sitting in a 45-minute queue for a $20 ride is a terrible use of your limited time.</li>");
                if (city.isHighTraffic()) {
                    practices.append("<li><strong>Traffic = Your Enemy:</strong> ").append(cityName).append(
            ...
            case SIDE_HUSTLE:
                practices.append(
                        ...
                        .append(cityName).append(", this can boost your hourly rate by 30%.</li>");
                practices.append(
                ...
                if (city.getGasPrice() > 4.0) {
                    practices.append("<li><strong>Gas Strategy in High-Cost ").append(cityName).append(
            ...
            case FULL_TIME:
                practices.append("<li><strong>Diversify Platforms:</strong> Never rely on just ").append(appName)
