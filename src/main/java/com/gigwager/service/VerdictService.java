    ...
    private Verdict getVerdictForWage(double wage, String appName) {
        if (wage < 8.0) {
            return new Verdict(
                    ...
                    "If your car breaks down tomorrow, could you afford to replace it?",
                    "red");
        } else if (wage < 15.0) {
            return new Verdict(
                    "SURVIVAL ZONE",
                    ...
                    "Is the flexibility of this gig really worth earning 40% less than a W-2 job?",
                    "orange");
        } else if (wage < 25.0) {
            return new Verdict(
                    "WORKABLE ZONE",
                    ...
                    "What small change in your driving habits could push you over $25/hr?",
                    "yellow");
        } else {
            return new Verdict(
                    "OPTIMIZATION ZONE",
                    ...
                    "How can you automate or scale this income further?",
                    "emerald");
        }
    }
}
